...
def retrieve():
    try:
        ...
        if 'query' not in data:
            return jsonify({"Retriever Error": "Missing 'query' in request"}), 400
        ...
        try:
            ...
            return jsonify({"Retriever Error": "Embedding service request failed", "details": str(e)}), 500
        ...
        try:
            ...
            return jsonify({"Retriever Error": "Invalid response format from embedding service", "details": str(e)}), 500
        ...
        try:
            ...
            return jsonify({"Retriever Error": "Vector DB service request failed", "details": str(e)}), 500
        ...
        try:
            ...
            return jsonify({"Retriever Error": "Invalid JSON response from vector DB", "details": str(e)}), 500

    except Exception as e:
        print("Unexpected error in /retrieve route:", e)
        return jsonify({"Retriever Error": "Internal server error", "details": str(e)}), 500
